# RuneSchema: Official 0.6.0 vs. Experimental 0.6.1

## What is being compared

This document compares the official RuneSchema `0.6.0` release with experimental build `v8`. The experimental build identifies its DLL as `0.6.1`, but it is a community variant rather than an official upstream RuneSchema release.
...
V8 provides optional spawn drop multiplication as an explicitly experimental feature. Size and drops are independent: `Scale` never changes drops, while an explicit `DropIncreasePercent` changes supported live-instance drop rows. The feature can be disabled without disabling spawn scale.

## At a glance

| Area | Official 0.6.0 | Experimental v8 |
|---|---|---|
...
This document describes `RuneSchema-v0.6.1-Experimental-v8.zip`.

- Shipping target: `Game__Shipping__Win64`
- DLL size: `2,293,760` bytes
- DLL SHA-256: `766444BDA2B9C7F408107AC91A334D54C09F4ED0D5D835D0D3642808B4830942`
- Package SHA-256: `643386ED2C8192CD66D95DC7BE825AD2D530BFBDC5BF9E3AED004125BE78E55D`
